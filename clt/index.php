...
<div class="card">
	<div class="card-header text-center" style="font-size: 20pt;">
		Salário Líquido CLT <small style="font-size: 11pt;"><?= date('Y') ?></small>
	</div>
	<div class="card-body">
		
		<form class="forms-sample d-print-none" action="calcular_salario_liquido.php" method="post" style="border-bottom: 1px solid;">
			<div class="row">
				<div class="col-9">
		...
		<br><br>
		<?php require_once "table_clt.php" ?>
	</div>
</div>
