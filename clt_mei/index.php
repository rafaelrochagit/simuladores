...
<div class="card">
	<div class="card-header text-center" style="font-size: 20pt;">
		CLT x MEI <small style="font-size: 11pt;"><?= date('Y') ?></small>
	</div>
	<div class="card-body">
		
		<form class="forms-sample d-print-none" action="calcular_clt_mei.php" method="post" style="border-bottom: 1px solid;">
			<div id="CLT">
				<div class="row">
					<div class="col-8">
				...
				<div class="row mb-4">
					<div class="col text-center">
						<a class="btn btn-dark" onclick="toMEI()">Próximo ></a>
					</div>
				</div>
			</div>
			<div id="MEI">
