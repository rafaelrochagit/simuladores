...
<?php
	if($erroForm != null) {
		$tabelaIrpf = $erroForm;
	} else if ($tabelaIrpfCarregada != null) {
		$tabelaIrpf = $tabelaIrpfCarregada;
	} else {
...
?>
	<div class="row mb-3">
		<div class="col">
   			<a href="tabelas_irpf_lista.php" class="btn btn-success">Lista</a>
		</div>
	</div>
	<div class="card">
	  <div class="card-header" style="font-size: 20pt;">
	    IRPF <small style="font-size: 11pt;"><?= date('Y') ?></small>
	  </div>
	  <div class="card-body">
	    <h4 class="card-title text-center mb-5">Tabela de Recolhimento do IRPF</h4>
            ...
            <div class="form-group row">
            	...
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa1']['piso']?>" onchange="faixa1()"> 
			      	</div>
            	</div>
            	<div class="col">
	            	<div class="input-group">
				        ...
				        <input class="form-control money" name="faixa1[teto]" 
				         value="<?=$tabelaIrpf['faixa1']['teto']?>" onchange="faixa1()"> 
			      	</div>
            	</div>
            	<div class="col">
	            	<div class="input-group">
				        <input class="form-control percent" name="faixa1[percent]" 
				        value="<?=$tabelaIrpf['faixa1']['percent']?>" onchange="faixa1()">
            	...
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa1']['deducao']?>" > 
			      	</div>
            	</div>
            </div>
            <div class="form-group row">
            	...
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa2']['piso']?>" onchange="faixa2()"> 
			      	</div>
            	</div>
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa2']['teto']?>" onchange="faixa2()"> 
			      	</div>
            	</div>
            	<div class="col">
	            	<div class="input-group">
				        <input class="form-control percent" name="faixa2[percent]" 
				        value="<?=$tabelaIrpf['faixa2']['percent']?>" onchange="faixa2()">
				        <div class="input-group-append">
				          <div class="input-group-text">%</div>
				        </div>
			      	</div>
            	...
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa2']['deducao']?>" > 
			      	</div>
            	</div>
            </div>
            <div class="form-group row">
            	...
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa3']['piso']?>" onchange="faixa3()"> 
			      	</div>
            	</div>
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa3']['teto']?>" onchange="faixa3()"> 
			      	</div>
            	</div>
            	<div class="col">
	            	<div class="input-group">
				        <input class="form-control percent" name="faixa3[percent]" 
				        value="<?=$tabelaIrpf['faixa3']['percent']?>" onchange="faixa3()">
				        <div class="input-group-append">
				          <div class="input-group-text">%</div>
				        </div>
			      	</div>
            	...
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa3']['deducao']?>" > 
			      	</div>
            	</div>
            </div>
            <div class="form-group row">
            	...
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa4']['piso']?>" onchange="faixa4()"> 
			      	</div>
            	</div>
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa4']['teto']?>" onchange="faixa4()"> 
			      	</div>
            	</div>
            	<div class="col">
	            	<div class="input-group">
				        <input class="form-control percent" name="faixa4[percent]" 
				        value="<?=$tabelaIrpf['faixa4']['percent']?>" onchange="faixa4()">
				        <div class="input-group-append">
				          <div class="input-group-text">%</div>
				        </div>
			      	</div>
            	...
            	<div class="col">
	            	<div class="input-group">
				        ...
				        value="<?=$tabelaIrpf['faixa4']['deducao']?>" > 
			      	</div>
            	</div>
            </div>
         	<div class="form-group row">
            	...
            	<div class="col">
						<div class="input-group">
							...
							value="<?=$tabelaIrpf['faixa5']['piso']?>" onchange="teto()"> 
						</div>
            	</div>
            	<div class="col">
						<div class="input-group">
							...
							value="<?=$tabelaIrpf['faixa5']['teto']?>" readonly> 
						</div>
            	</div>
            	<div class="col">
	            	<div class="input-group">
						<div class="input-group">
							...
							value="<?=$tabelaIrpf['faixa5']['percent']?>" onchange="teto()">
							<div class="input-group-append">
							<div class="input-group-text">%</div>
							</div>
						</div>
            	...
            	<div class="col">
	            	<div class="input-group">
				        ...
				        <input class="form-control" name="faixa5[deducao]" 
				        value="<?=$tabelaIrpf['faixa5']['deducao']?>" > 
			      	</div>
            	</div>
            </div>
		...
		<div class="alert alert-warning text-center">
			<strong>Base de cálculo = </strong> salário bruto - contribuição para o INSS - pensão alimentícia - 
			(número de dependentes x 189,59)
		</div>
		<div class="alert alert-warning text-center">
			<strong>IRRF = </strong>base de cálculo x alíquota - dedução
		</div>
	  </div>
	</div>
