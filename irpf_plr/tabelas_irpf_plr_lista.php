...
<?php
	$tabelas = $irpfPlr->readTabelas();
?>


	<div class="row mb-3">
		<div class="col">
			<a class="btn btn-primary" href="tabela_irpf_plr.php">Voltar</a>
		</div>
	</div>
	<h2 class="text-center">Tabelas IRPF PLR</h2>
	<div class="row">
		<div class="col">
      ...
      <div class="modal-body">
        <div class="row">
     	...
     	<div class="row mt-2">
        	...
        	<div class="col">R$ <span id="deducao1"></span></div>
        </div>
        <div class="row mt-2">
        	...
        	<div class="col">R$ <span id="deducao2"></span></div>
        </div>
        <div class="row mt-2">
        	...
        	<div class="col">R$ <span id="deducao3"></span></div>
        </div>
        <div class="row mt-2">
        	...
        	<div class="col">R$ <span id="deducao4"></span></div>
        </div>
        <div class="row mt-2">
        	<div class="col"><h6>Teto</h6></div>
        	<div class="col">R$ <span id="piso5"></span></div>
        	<div class="col"><span id="teto5"></span></div>
        	<div class="col"><span id="percent5"></span>%</div>
        	<div class="col">R$ <span id="deducao5"></span></div>
        </div>
      </div>
    </div>
    </div>
...
<script type="text/javascript">
	...
	function preencheModal(tabela, i) {
		...
		$("#deducao"+i).text(tabela['faixa'+i]['deducao']);
	}
